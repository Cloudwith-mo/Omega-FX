...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a capital-plan surface for FTMO PLAN_D scenarios.")
    parser.add_argument("--firm", type=str, default="FTMO_CHALLENGE")
    parser.add_argument("--months", type=int, default=12)
    parser.add_argument("--initial_bankrolls", type=float, nargs="+", default=[2000, 5000, 10000])
    ...
    parser.add_argument("--reinvest_fractions", type=float, nargs="+", default=[0.5, 0.7, 0.9])
    parser.add_argument("--feeder_fee", type=float, default=60.0, help="Feeder eval fee.")
    parser.add_argument("--large_fee", type=float, default=350.0, help="Large (100k) eval fee.")
    parser.add_argument("--stage2_trigger", type=float, default=10000.0, help="Payout trigger for stage 2.")
    parser.add_argument("--stage1_month_limit", type=float, default=6.0, help="Month index to automatically enter stage 2.")
    parser.add_argument("--large_fraction", type=float, default=0.5, help="Fraction of evals that become large in stage 2.")
    parser.add_argument("--risk_budget_fraction", type=float, default=0.7)
    parser.add_argument("--eval_runs", type=Path, default=Path("results/minimal_ftmo_eval_runs.csv"))
    parser.add_argument("--funded_runs", type=Path, default=Path("results/funded_payout_ftmo_12m_runs.csv"))
    parser.add_argument("--funded_horizon_months", type=int, default=12)
    parser.add_argument("--simulations", type=int, default=10000)
    parser.add_argument("--seed", type=int, default=123)
    parser.add_argument("--output", type=Path, default=Path("results/capital_surface_ftmo_plan_d_12m.csv"))
