...
def run_backtest(
    ...
    *,
    ...
    challenge = replace(
        challenge,
        max_total_loss_fraction=firm_profile_cfg.prop_max_total_loss_fraction,
        max_daily_loss_fraction=firm_profile_cfg.prop_max_daily_loss_fraction,
    )
    ...
    try:
        ...
        for event in events:
            ...
            for position in list(matching_positions):
                ...
                if exit_price is None and opposite_direction and opposite_direction != position.direction:
            ...
            for signal in signals:
                ...
                if entry_allowed:
                    ...
                    strategy_multiplier = float(strategy_config.get("risk_scale_multiplier", 1.0) or 1.0)
        ...
        return BacktestResult(
            ...
            open_position_histogram=open_position_histogram,
        )
    finally:
